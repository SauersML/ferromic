    ...
    register(
        SheetInfo(
            ...
            description=(
                ...
                "computed within the selected phenotype set. Confidence bounds are computed as in the PheWAS results "
                "sheet."
            ),
    ...
    register(
        SheetInfo(
            ...
            description=(
                ...
                "models that did not converge or gave unstable fits. Confidence intervals are computed as in the "
                "PheWAS results sheet."
            ),
