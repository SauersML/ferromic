...
PHEWAS_COLUMN_DEFS: Dict[str, str] = OrderedDict(
    [
        ...
        ("Description", "The clinical description of the phecode."),
        ("group", "The broad clinical category of the phenotype (e.g., Neoplasms, Dermatologic)."),
        ("N_Cases", "Number of participants with the phenotype (cases) in the All of Us v8 cohort."),
        ("N_Controls", "Number of participants without the phenotype (controls)."),
        ("OR", "Odds Ratio representing the change in disease odds per unit increase in inversion dosage."),
        ("P_Value_unadjusted", "Nominal p-value from the logistic regression likelihood ratio test."),
        ("BH_FDR_Q", "Benjamini-Hochberg FDR q-value."),
        ("Inversion", "The Inversion ID being tested."),
        (
            "ancestry_interaction_p",
            "P-value for the interaction term between inversion dosage and genetic ancestry, testing if effect size varies by population.",
        ),
    ]
)
...
TAG_PHEWAS_COLUMN_DEFS: Dict[str, str] = OrderedDict(
    [
        ...
        ("N_Cases", "Number of participants with the phenotype (cases) in the All of Us v8 cohort."),
        ("N_Controls", "Number of participants without the phenotype (controls)."),
        ("OR", "Odds Ratio representing the change in disease odds per unit increase in tagging SNP genotype."),
        ("P_Value_unadjusted", "Nominal p-value from the logistic regression likelihood ratio test."),
        ("BH_FDR_Q", "Benjamini-Hochberg FDR q-value."),
        ("Inversion", "The Inversion ID being tested."),
        (
            "ancestry_interaction_p",
            "P-value for the interaction term between tagging SNP genotype and genetic ancestry, testing if effect size varies by population.",
        ),
    ]
)
