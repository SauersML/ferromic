...
tagging-SNP-versus-imputed-dosage comparison (three tagging SNPs, unanimity
dosage) was Figure S11 of the submitted supplement and is Figure S19 in the
revision, cited with Table S21. The single-SNP concordance plot from
``stats/tag_vs_imputed_concordance.py`` appears only in the response letter.
"""
...
FINAL_SUPPLEMENTARY_FIGURES = (
    ...
    SupplementaryFigure(
        ...
        "The ancestral and derived orientations are determined with respect to the chimpanzee (mPanTro3) for 59 inversion loci (Table S9). The 34 loci with at least two haplotypes in each orientation are shown: single-event (left, n = 21) or recurrent (right, n = 13). The distribution of nucleotide diversity (π) across loci is shown for each of the groups. The boxplot shows the median and interquartile range. The lines connect the ancestral and derived orientations at the same locus, which are colored by the log_{2} of (π_{ancestral} / π_{derived}), a measure of fold change in diversity.",
    ),
    SupplementaryFigure(
        10,
