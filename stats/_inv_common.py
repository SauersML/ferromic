...
Orientation is reported in the raw hg38-reference encoding throughout: group/
allele **0 == "direct"** is the hg38 reference arrangement and **1 == "inverted"**
is the other one (the published Porubsky call). No ancestral/derived polarization
is applied.
"""
