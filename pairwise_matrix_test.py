...
def create_manhattan_plot(results_df, inv_file='inv_info.csv', top_hits_to_annotate=10):
    ...
    recurrent_large_patch = mpatches.Patch(facecolor='none', edgecolor=recurrent_color, hatch='//', label='Large recurrent inversion')
    single_large_patch = mpatches.Patch(facecolor='none', edgecolor=single_color, hatch='//', label='Large single-event inversion')
